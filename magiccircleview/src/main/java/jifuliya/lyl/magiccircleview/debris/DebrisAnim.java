...
public class DebrisAnim extends ValueAnimator {

    static long DEFAULT_DURATION = 0x400;
    private static final Interpolator DEFAULT_INTERPOLATOR = new AccelerateInterpolator(0.6f);
    private static final float END_VALUE = 1.4f;
    private static final float X = MagicUtils.dp2Px(5);
    private static final float Y = MagicUtils.dp2Px(20);
    private static final float V = MagicUtils.dp2Px(2);
    private static final float W = MagicUtils.dp2Px(1);
    private Paint mPaint;
    private Particle[] mParticles;
    private Rect mBound;
    private View mContainer;

    public DebrisAnim(View container, Bitmap bitmap, Rect bound) {
        mPaint = new Paint();
